...
//----------------------------------------------------
   ...
   export class WebBrowserHost extends Atomic.AObject {
      ...
      debugPort: number;
      webSecurity: boolean;
      jSMessageQueryFunctionName: string;
      jSMessageQueryCancelFunctionName: string;
...
declare module WebView {
    /**
     * Instance of WebBrowsrHost available to all windows
     */
    export var browserHost: WebBrowserHost;
}
// Duktape built-ins
